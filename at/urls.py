...
urlpatterns = [
    ...
    path('PatintDisplayAll/',views.PatintDisplayAll,name='PatintDisplayAll'),
    path('AppointmentFormReceptionist/',views.AppointmentFormReceptionist,name='AppointmentFormReceptionist'),
    path('AppointmentsDisplayAll/',views.AppointmentsDisplayAll,name='AppointmentsDisplayAll'),
